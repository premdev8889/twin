...
export default function Home() {
  ...
  // ✅ Dynamic words for heading
  const techWords = ["Workday", "SAP", "Success Factors", "Sales force", "Service Now"];
    ...
    <div className="mx-auto max-w-6xl px-3 sm:px-6 py-8">
      ...
      <h1 className="text-center font-medium leading-tight text-[28px] sm:text-[34px] md:text-[42px]">
        ...
        <span
          ...
          className="text-blue-700 text-[40px] transition-opacity duration-700 ease-in-out"
          style={{
